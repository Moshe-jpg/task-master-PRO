...
$(".card .list-group").sortable({connectWith: $(".card .list-group"), scroll: false, tolerance: "pointer", helper: "clone",
...
// audit the tasks to give it a color based on how many days are left to the task or if past its due date
